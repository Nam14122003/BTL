...
def chat_endpoint(request: ChatRequest):
    try:
        ...
        # Nếu độ tương đồng vượt ngưỡng, trả về câu trả lời có sẵn từ FAQ mà không cần qua LLM
        ...
        # Sử dụng LLM để trả lời, kết hợp với context nếu có
        ...
        # Thêm thông tin bổ sung nếu là kết quả từ MongoDB
